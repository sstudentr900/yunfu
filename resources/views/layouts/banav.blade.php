<div class="flex pt-4 px-6 min-h-[60px] justify-between relative">
  <div class="relative">
    <h4 class="absolute -top-6 bg-main py-5 px-10 w-screen min-w-[180px] max-w-[220px] text-lg font-bold text-center text-white rounded-sm shadow-lg">{{ $mainTitle }}</h4>
  </div> 
  @if($addbtn=='y')
