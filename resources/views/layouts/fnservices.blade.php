...
<div class="m-auto mb-18 pr-8 relative max-w-7xl max-md:px-4 max-md:mb-8 max-sm:pl-0">
  <div class="gsapTextTop z-10 inline-flex flex-col justify-start items-start mb-4 max-lg:items-end max-lg:absolute max-lg:bg-white max-lg:right-8 max-lg:top-5 max-lg:p-2">
    <div class="overflow-hidden">
      <div class="gsapText text-main text-2xl max-md:text-lg">服務項目</div>
    </div>
    <div class="overflow-hidden">
      <div class="gsapText justify-center text-neutral-800 text-7xl customFont3 uppercase max-sm:text-5xl">Services</div>
    </div>
  </div>
  <div class="flex justify-start items-start gap-12 max-lg:gap-0 max-lg:flex-col">
    ...
    <div class="overflow-hidden flex-2 max-lg:-mt-24 max-md:-mt-40">
      <div class="gsapRight grid grid-cols-2 gap-10 max-lg:bg-white/70 max-lg:p-4 max-lg:ml-8 max-md:ml-4 max-md:grid-cols-1 max-md:gap-8">
        <div class="">
