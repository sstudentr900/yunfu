...
<div class="md:mb-18 max-md:mb-8 relative">
  ...
  <div class="absolute inset-0 flex flex-col items-center justify-center">
    <div class="text-white customFont3 text-7xl max-md:text-5xl">ABOUT US</div>
...
<div class="flex justify-center items-center mx-auto mb-18 max-w-7xl md:px-8 max-lg:px-4 max-md:flex-col-reverse max-md:max-w-[580px] max-md:mb-8">
  <div class="relative md:max-w-[480px] md:min-w-[390px] flex flex-1 flex-col items-end p-8 bg-white -mr-10 max-lg:py-4 max-md:mr-0 max-md:p-0 max-md:mt-4 max-md:items-start">
    ...
    <div class="text-end uppercase text-neutral-800 customFont3 text-5xl mb-4 max-xl:text-5xl break-all max-md:text-3xl max-md:mb-1 max-md:text-start">Brand<br class="max-md:hidden"> Story</div>
...
<div class="flex justify-center items-center mx-auto mb-18 max-w-7xl md:px-8 max-lg:px-4 max-md:flex-col max-md:max-w-[580px] max-md:mb-8">
  ...
  <div class="relative md:max-w-[480px] md:min-w-[390px] flex flex-1 flex-col items-start p-8 bg-white -ml-10 max-lg:py-4 max-md:ml-0 max-md:p-0 max-md:mt-4">
    ...
    <div class="uppercase text-neutral-800 customFont3 text-5xl mb-4 max-xl:text-5xl break-all max-md:text-3xl max-md:mb-1 max-md:text-start">Business<br class="max-md:hidden"> philosophy</div>
...
<div class="flex justify-center items-center mx-auto mb-18 max-w-7xl md:px-8 max-lg:px-4 max-md:flex-col-reverse max-md:max-w-[580px] max-md:mb-8">
  <div class="relative md:max-w-[480px] md:min-w-[390px] flex flex-1 flex-col items-end p-8 bg-white -mr-10 max-lg:py-4 max-md:mr-0 max-md:p-0 max-md:mt-4 max-md:items-start">
    ...
    <div class="text-end uppercase text-neutral-800 customFont3 text-5xl mb-4 max-xl:text-5xl break-all max-md:text-3xl max-md:mb-1 max-md:text-start">Our<br class="max-md:hidden"> strength</div>
    <div class="text-end text-neutral-500 text-lg max-md:text-sm max-md:text-start">
...
<div class="relative">
  ...
  <div class="absolute inset-0 flex max-md:flex-col max-md:h-auto">
    ...
    <div class="h-full flex-1 flex flex-col justify-center items-center gap-4 p-4 max-md:w-full max-md:py-12 max-md:gap-2 bg-main/70">
      ...
      <a href="{{ route('fncontact') }}" class="bg-white w-fit px-16 py-3 rounded-[999px] gap-2 text-neutral-800 text-2xl font-normal hover:bg-neutral-800 hover:text-white max-md:text-base max-md:px-8 max-md:py-2">
        立即諮詢
      </a>
    </div>
  </div>
