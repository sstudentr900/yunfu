...
<div class="flex items-center justify-center mb-18">
  <a class="cursor-pointer bg-white px-10 py-2 rounded-[999px] text-neutral-500 text-xl hover:bg-neutral-800 hover:text-white hover:border-neutral-800 max-md:text-base border border-neutral-300">回上一頁</a>
</div>
